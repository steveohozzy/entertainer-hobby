                          ...
                          return (
                            ...
                            >
                              <input
                                ...
                                c className="relative mt-1 block size-[20px] appearance-none rounded-md border-[3px] border-textBlue bg-transparent outline-none transition-all checked:border-purple-500 peer"
                              />
                              <span className="absolute top-[5px] left-[-6px] text-transparent peer-checked:text-purple-500">
                                <svg viewBox="0 0 24 24" width="16px" height="16px" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
