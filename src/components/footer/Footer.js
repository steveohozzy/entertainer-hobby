        ...
        <div className="bg-gray-900 p-4">
          <div className="max-w-7xl mx-auto px-4 pr-0 sm:px-6 lg:px-8">
            ...
            <div className="mb-6 flex flex-col items-center md:w-1/3 md:items-stretch md:pr-4">
              <span className="font-[26px] font-semibold text-gray-100 text-center w-[275px]">Be in the know with</span>
              <img src="/footer-logo.svg" alt="The Entertainer" className="w-[225px] lg:w-[275px]" width="225" height="33" />
              <span className="mt-3 w-[225px] text-center text-sm font-semibold text-gray-100 md:font-[20px] lg:w-[275px]">Sign up to our emails</span>
            </div>
              ...
              <form className="flex flex-wrap">
                <div className="mb-4 w-full md:w-1/2">
                  <input
                    ...
                    className="h-[34px] w-full rounded-lg border-[3px] border-brandBlue bg-transparent px-3 text-textgray-100 transition-all placeholder:text-gray-100 placeholder:font-semibold  focus:outline-none"
                  />
                  <input
                    type="email"
                    placeholder="Email Address*"
                    className="mt-4 h-[34px] w-full rounded-lg border-[3px] border-brandBlue bg-transparent px-3 text-textgray-100 transition-all placeholder:text-gray-100 placeholder:font-semibold  focus:outline-none"
                  />
                </div>
            ...
            <div className="flex items-center justify-center text-center mb-4">
              <div className="text-xl text-purple-500 font-semibold mr-2">
                Follow us on
              </div>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="ml-1 transition-all hover:rotate-[20deg] text-gray-100 hover:text-purple-500"
              >
                <svg
                  width="18"
                  height="26"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="ml-2 transition-all hover:rotate-[20deg] text-gray-100 hover:text-purple-500"
              >
                <svg
                  width="22"
                  height="22"
            ...
            <div className="flex flex-wrap items-start justify-center">
              <div className="px-4 w-full md:w-auto flex flex-col items-center items-center md:items-start mb-4">
                <Dropdown
                  title="Help"
                  className="text-gray-100 font-semibold flex items-center"
                  answer={
                    <ul className="text-gray-100 text-center md:text-left">
                      <li className="mt-2">
                        <button
                          onClick={() => {
